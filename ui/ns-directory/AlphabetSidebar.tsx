...
export default function AlphabetSidebar({ letters, activeLetter, onSelect, show }: AlphabetSidebarProps) {
  ...
  const getLetterFromEvent = (e: React.PointerEvent<HTMLDivElement> | React.TouchEvent<HTMLDivElement>): string | null => {
