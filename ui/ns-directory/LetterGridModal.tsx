interface LetterGridModalProps {
  letters: string[];
  onSelect: (letter: string) => void;
  onClose: () => void;
}

export default function LetterGridModal({ letters, onSelect, onClose }: LetterGridModalProps) {
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-50 flex items-center justify-center" onClick={onClose}>
