export const FIELD_FOCUS_INTERACTION_CLASSES =
  "transition-[border-color,border-width] duration-150 hover:border-[var(--color-brand-blue)] focus:border-[var(--color-brand-blue)] focus:border-2";
...
export const FIELD_FOCUS_WITHIN_INTERACTION_CLASSES =
  "transition-[border-color,border-width] duration-150 hover:border-[var(--color-brand-blue)] focus-within:border-[var(--color-brand-blue)] focus-within:border-2";
