  ...
  return (
    <div className="mb-4 p-3 rounded-lg border border-gray-800 overflow-hidden" style={{ backgroundColor: 'var(--color-background)' }}>
      ...
      <input
        ...
        className="w-full border border-gray-800 px-3 py-2 rounded-lg text-sm text-gray-900 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 bg-white mb-4"
      />
