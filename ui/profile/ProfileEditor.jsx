...
function createDeleteToggle(field, originals, setDeletedFields, setForm, handleChange) {
  return () =>
    setDeletedFields((prev) => {
      ...
      if (next) {
        ...
        setForm((f) => ({ ...f, [field]: originals[field] }));
      }
  ...
  const addLink = () =>
    setForm((prev) => ({
      ...
      links: [
        ...prev.links,
        {
          id: null, url: "", platform: "X", username: "", otherUrl: "",
