...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 text-gray-800 dark:text-gray-200">
      ...
      <h1 className="text-3xl font-bold mb-4">Privacy Policy for Zcash Verification Service</h1>
      <p className="mb-4 text-sm text-gray-500 dark:text-gray-400">Last Updated: December 10, 2025</p>

      <div className="space-y-6">
        <section>
          <h2 className="text-xl font-semibold mb-2">1. Information We Collect</h2>
          <p className="mb-2">To provide our verification service, we collect the following information:</p>
        ...
        <section>
          ...
          <p className="mb-2">We use this data solely to:</p>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          ...
          <p>Your data is stored securely using Supabase. We do not sell, trade, or rent your personal identification information to others.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-2">4. Data Removal</h2>
          <p>You may request the deletion of your verification record at any time by contacting us.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-2">5. Contact</h2>
          <p>If you have questions, please contact us at james.edaclinical.com.</p>
        </section>
      </div>
    </div>
  );
