...
function validateBtcAddress(address: string): BlockchainValidation {
...
function validateEthAddress(address: string): BlockchainValidation {
  if (!address || typeof address !== "string") {
...
function validateSolAddress(address: string): BlockchainValidation {
  if (!address || typeof address !== "string") {
...
function validateNearAddress(address: string): BlockchainValidation {
  if (!address || typeof address !== "string") {
...
function validateZecAddress(address: string): BlockchainValidation {
  if (!address || typeof address !== "string") {
