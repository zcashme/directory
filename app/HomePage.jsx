      ...
      <div className="max-w-lg mx-auto px-4 pt-6 pb-4">
        ...
        <div className="relative mb-8">
          ...
          <motion.div
            ...
            className="relative bg-white rounded-2xl shadow-xl border border-green-100 p-6 max-w-lg mx-auto"
          >
            ...
            {[
              ...
              >
                <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-black text-green-700">{step.number}</span>
                </div>
