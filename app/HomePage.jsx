        ...
        <div className="max-w-lg mx-auto px-4">
          <div className="flex justify-center items-center gap-6 relative">
            ...
            <div className="absolute right-0 flex flex-col gap-0.5 text-xs text-gray-500">
              <Link href="/terms" className="hover:text-gray-600 transition-colors leading-relaxed">
                Terms
              </Link>
              <Link href="/privacy" className="hover:text-gray-600 transition-colors leading-relaxed">
                Privacy
              </Link>
            </div>
          </div>
